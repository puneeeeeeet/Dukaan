...
function SideBar() {
  return (
    <div className=" bg-blueGray w-60 text-white h-full static">
      <div className="mt-4 mx-2.5 w-52 h-full flex-col">
        ...
        <div className=" inline-flex items-center">
          ...
          <div className=" ml-3  relative">
            ...
            <div className="font-light h-4 mt-1 text-xs underline">
              Visit store
            </div>
          </div>
          <div className="  ">
        ...
        {/* <SidebarButtons /> */}
        <div className="mt-6 mx-2.5 w-52 gap-y-1  flex flex-col">
        ...
        <div className="ml-5 absolute px-3 py-1.5 bottom-0 left-0 w-52 h-14 bg-gray rounded mb-4">
          <div className="w-full h-full gap-3 inline-flex">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-base">222.10</div>
            </div>
            <div></div>
          </div>
        </div>
